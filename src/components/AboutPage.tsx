...
const AboutPage = () => {
  const milestones = [
    {
      year: "2000",
      event: "Company founded with a focus on quality plumbing solutions",
    },
    {
      year: "2005",
      event: "Expanded manufacturing facility and introduced CPVC pipes",
    },
    ...
    {
      year: "2020",
      event: "Digital transformation and online ordering system",
    },
  ...
  const values = [
    {
      icon: (
        <CheckCircle className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-plumbing-primary" />
      ),
      title: "Quality First",
      description:
    ...
    {
      icon: (
        <Users className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-plumbing-primary" />
      ),
      title: "Customer Focus",
      description:
        "We prioritize customer satisfaction through reliable products and exceptional service.",
    },
    {
      icon: (
        <Globe className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-plumbing-primary" />
      ),
      title: "Innovation",
      description:
        "Continuously developing new solutions to meet evolving industry requirements.",
    },
    {
      icon: (
        <Target className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-plumbing-primary" />
      ),
      title: "Reliability",
      description:
        "Consistent quality and timely delivery that professionals can depend on.",
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-64 sm:h-80 md:h-96 lg:h-[28rem] xl:h-[32rem] flex items-center justify-center text-center text-white">
        ...
        <div className="relative z-20 responsive-container">
          ...
          <p className="responsive-text-lg md:responsive-text-xl lg:text-2xl text-gray-200 max-w-4xl mx-auto px-4">
            Building India's infrastructure with premium plumbing solutions
            since 2000
          </p>
        </div>
      </section>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="responsive-container">
          <div className="flex mx-96 gap-8 sm:gap-10 lg:gap-12 xl:gap-16 items-center">
            <div className="animate-slide-in order-2 lg:order-1">
              ...
              <p className="responsive-text-base md:responsive-text-lg text-plumbing-gray mb-4 sm:mb-6 leading-relaxed">
                To provide superior quality plumbing components that ensure
                reliable, long-lasting performance for residential, commercial,
                and industrial applications. We are committed to supporting
                India's infrastructure development through innovative products
                and exceptional customer service.
              </p>
              <p className="responsive-text-base md:responsive-text-lg text-plumbing-gray mb-6 sm:mb-8 leading-relaxed">
                Since our establishment in 2000, Shubham Plastic has grown from
                a small manufacturing unit to one of India's most trusted names
                in plumbing components. Our state-of-the-art manufacturing
                facility combines traditional craftsmanship with modern
                technology to deliver products that exceed industry standards.
              </p>
        ...
        <div className="responsive-container">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="responsive-text-lg md:responsive-text-xl text-blue-100 max-w-3xl mx-auto px-4 leading-relaxed">
              ...
              processes, international certifications, and continuous
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-4 sm:p-6 bg-white bg-opacity-10 backdrop-blur-sm rounded-lg">
              ...
              <p className="responsive-text-sm md:responsive-text-base text-blue-100 leading-relaxed">
                In-house testing facility with advanced equipment for quality
                verification
              </p>
            </div>
            <div className="text-center p-4 sm:p-6 bg-white bg-opacity-10 backdrop-blur-sm rounded-lg">
              ...
              <p className="responsive-text-sm md:responsive-text-base text-blue-100 leading-relaxed">
                Stringent quality checks on all incoming raw materials and
                components
              </p>
            </div>
            <div className="text-center p-4 sm:p-6 bg-white bg-opacity-10 backdrop-blur-sm rounded-lg">
              ...
              <p className="responsive-text-sm md:responsive-text-base text-blue-100 leading-relaxed">
                100% inspection of finished products before packaging and
                dispatch
              </p>
            </div>
          </div>
